...
-- 4. 创建function
create function currency_type_convert as 'com.alonzo.transformer.hive.CurrencyTypeDimensionUDF' using jar 'hdfs://hadoop:8020/alonzo/transformer/transformer-0.0.1.jar';
create function payment_type_convert as 'com.alonzo.transformer.hive.PaymentTypeDimensionUDF' using jar 'hdfs://hadoop:8020/alonzo/transformer/transformer-0.0.1.jar';
create function order_info as 'com.alonzo.transformer.hive.OrderInfoUDF' using jar 'hdfs://hadoop:8020/alonzo/transformer/transformer-0.0.1.jar';
create function order_total_amount as 'com.alonzo.transformer.hive.OrderTotalAmountUDF' using jar 'hdfs://hadoop:8020/alonzo/transformer/transformer-0.0.1.jar';
...
insert overwrite table order_info select oid,pl,s_time,cut,pt,cua 
	sqoop脚本
sqoop export --connect jdbc:mysql://hadoop:3306/report --username hive --password hive --table order_info --export-dir /hive/bigdater.db/order_info/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key order_id
...
-- 8. 订单数量sqoop(总的)
sqoop export --connect jdbc:mysql://hadoop:3306/report --username hive --password hive --table stats_order --export-dir /hive/bigdater.db/stats_order_tmp2/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,date_dimension_id,currency_type_dimension_id,payment_type_dimension_id --columns platform_dimension_id,date_dimension_id,currency_type_dimension_id,payment_type_dimension_id,orders,created

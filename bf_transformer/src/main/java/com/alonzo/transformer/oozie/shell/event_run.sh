...
sqoop export --connect jdbc:mysql://hadoop:3306/report --username hive --password hive --table stats_event --export-dir /hive/bigdater.db/stats_event/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,data_dimension_id,event_dimension_id

...
public class PageViewRunner extends TransformerBaseRunner {
	...
	public static void main(String[] args) {
		...
		runner.setupRunner("website_pageview", PageViewRunner.class, PageViewMapper.class, PageViewReducer.class, StatsUserDimension.class, NullWritable.class, StatsUserDimension.class,
	...
	protected Filter fetchHbaseFilter() {
		...
		// 只需要pageview事件
		filterList.addFilter(new SingleColumnValueFilter(PageViewMapper.family, Bytes.toBytes(EventLogConstants.LOG_COLUMN_NAME_EVENT_NAME), CompareOp.EQUAL, Bytes
				.toBytes(EventLogConstants.EventEnum.PAGEVIEW.alias)));
		// 定义mapper中需要获取的列名

...
public class InboundRunner extends TransformerBaseRunner {
	...
	public static void main(String[] args) {
		...
		runner.setupRunner("inbound", InboundRunner.class, InboundMapper.class, InboundReducer.class, StatsInboundDimension.class, TextsOutputValue.class, StatsInboundDimension.class,
